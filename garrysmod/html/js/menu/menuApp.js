...
{
	$routeProvider.when('/', { templateUrl: 'template/ifn.html' } );
	...
	$routeProvider.when('/default/', { templateUrl: 'template/main.html' } );
	$routeProvider.when('/mservers/', { templateUrl: 'template/mservers.html' } );
	$routeProvider.when('/eservers/', { templateUrl: 'template/eservers.html' } );
	$routeProvider.when('/links/', { templateUrl: 'template/links.html' } );
} );
